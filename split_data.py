...
# 原始数据集路径（替换为解压后的路径）
original_data_path = "D:/Download/archive/garbage_classification"
# 目标路径
target_path = "dataset"

# 类别映射
class_mapping = {
    "battery": 0, "biological": 1, "brown-glass": 2, "cardboard": 3, "clothes": 4,
    "green-glass": 5, "metal": 6, "paper": 7, "plastic": 8, "shoes": 9,
    "trash": 10, "white-glass": 11
}
